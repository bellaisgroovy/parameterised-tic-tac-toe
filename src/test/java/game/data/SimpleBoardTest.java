...
public class SimpleBoardTest {
    ...
    public void get_CellAt_index_in_5D_array_returns_value_at_index() {
        Board board = new SimpleBoard(List.of(3,12,7,9,2), 3);
    ...
    public void get_CellAt_index_out_of_bounds_fails() {
        Board board = new SimpleBoard(List.of(2,4), 3);
        try {
    ...
    public void construct_9d_board() {
        Board board = new SimpleBoard(List.of(7,4,1,8,4,9,3,6,4), 3);
        int expected = 9;
    ...
    public void find_sizes_of_board() {
        ...
        Board board = new SimpleBoard(expectedSizes, 3);
        assertEquals(expectedSizes, board.getSizes());
    }

    @Test
    public void toString_board() {
        Board board = new SimpleBoard(List.of(2, 2, 2, 2), 3);
    ...
    public void fail_to_set_CellAt_negative_index() {
        Board board = new SimpleBoard(List.of(9,4,7), 3);
        try {
    ...
    public void can_retrieve_dimensions_of_board() {
        ...
        Board board = new SimpleBoard(sizes, 3);
